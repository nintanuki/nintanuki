...
- 👾 Learned object-oriented programming from make a [space-themed arcade shooter](https://github.com/nintanuki/star-hero) in Pygame.
- 🗡️ Made a small graphical [turn-based dungeon crawler](https://github.com/nintanuki/dig-adventure) from a previously text-based game.
